...
###########
    ...
    intensfierWords=[line[0].decode('utf-8') for line in intenSefier if len(line)>0]
...
def main():
    ...
    original_tweet=[s.decode('utf-8') for s in tested_tweet.readlines()]
...
##                negCount+=2
        ...
        c=c+1
        print c,':','(pos,neg,intens,stop,negation,nwords) = ',(Sum,negCount,intensity,stopCount,negationCount,nwords),'----  ''final_sentiment: ',result()
